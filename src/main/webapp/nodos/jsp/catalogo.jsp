...
<%
    ...
    for (int i = 0; i < dlprops.size(); i++) {
        ...
        sb.append("{name:\"").append(dobj.getString("name")).append("\"},\n");
        ...
        <script type="text/javascript">
            ...
            var grid = eng.createGrid({
                ...
                recordDoubleClick: function (grid, record)
                {
                    ...
                    window.location = "bicdetail.jsp?ds=<%=dsName%>&dsid=<%=id%>&id=" + record["_id"]+"&iscatalog=true";
                    return false;
                },
                ...
                addButtonClick: function (event)
                {
                    ...
                    window.location = "bicdetail.jsp?ds=<%=dsName%>&dsid=<%=id%>&iscatalog=true&id=";
                    return false;
                },
            <%=sb.toString()%>
//                fields: [
