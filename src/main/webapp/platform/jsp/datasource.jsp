<%@page import="com.mongodb.util.JSON"%><%@page import="java.io.*"%><%@page import="java.util.*"%><%@page import="org.semanticwb.datamanager.*"%><%@page contentType="application/json" pageEncoding="UTF-8"%><%!
//global
...
%><%
    ...
    try
    {
        ...
        if(referer!=null && origin!=null && referer.startsWith(origin))referer=referer.substring(origin.length());
        json.put("origin", origin);     
        json.put("referer", referer);     
        //System.out.println("origin:"+origin+" referer:"+referer);
        
        //System.out.println("dssp:"+dssp+" user:"+user);
