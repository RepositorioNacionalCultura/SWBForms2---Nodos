...
eng.dataSources["Extractor"] = {
    ...
    fields: [
        ...
        {name:"name",title:"Nombre de la colección",type:"string"},
        {name:"holderId",title:"Id Proveedor de datos",type:"string"},
        {name: "url", title: "URL", type: "string"},
...
//    displayField: "nombre",
//    fields: [
//        {name: "idsistema", title: "ID Sistema", required: true, type: "string"},
...
eng.dataSources["Serial"] = {
    scls: "Serial",
    modelid: "SWBForms",
    dataStore: "mongodb",
    displayField: "next",
    fields: [
        {name: "holderid", title: "ID Proveedor datos", type: "string", required: true},
        {name: "next", title: "Número consecutivo siguiente", type: "long", required: true, defaultValue: 0},
    ]
};